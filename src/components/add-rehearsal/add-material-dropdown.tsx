...
interface AddMaterialDropdownState {
  majorSectionTitle: string | undefined
  minorSectionTitle: string | undefined
}

class AddMaterialDropdown extends React.Component<AddMaterialDropdownProps, AddMaterialDropdownState> {
  state = {
...
export default AddMaterialDropdown 